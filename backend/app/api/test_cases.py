...
async def create_test_case(
    ...
    await crud_audit.create_audit_log(
        db,
        AuditLogCreate(
            user_id=current_user.id, action="create", resource_type="test_case", resource_id=str(new_test_case.id)
        ),
    )
...
async def update_test_case(
    ...
    await crud_audit.create_audit_log(
        db,
        AuditLogCreate(
            user_id=current_user.id, action="update", resource_type="test_case", resource_id=str(test_case_id)
        ),
    )
