...
class TestCase(Base, TimestampMixin):
    ...
    status = Column(Enum(TestCaseStatus, values_callable=_enum_values), nullable=False, default=TestCaseStatus.DRAFT)
    ...
    automation_status = Column(Enum(AutomationStatus, values_callable=_enum_values), default=AutomationStatus.MANUAL)
